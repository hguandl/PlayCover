...
> **DMG 安装包已发布。**  
> 下载地址：[Releases](https://github.com/WTHH031230/PlayCover/releases)。安装后请在终端执行：
> ```bash
> sudo xattr -cr /Applications/PlayCover.app
> ```
>
> **DMG installer is available.**  
> Download: [Releases](https://github.com/WTHH031230/PlayCover/releases). After installing, run in Terminal:
> ```bash
> sudo xattr -cr /Applications/PlayCover.app
> ```
